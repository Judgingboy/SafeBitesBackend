                        ...
                        <div class="card" style="opacity:0.9;">
                            ...
                            <div class="content all-icons">
                                ...
                                <a href="../user_tbl/select.php">    <div class="font-icon-detail"><i class="pe-7s-user"></i>
								  ...
								  <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                <a href="../ingredient_tbl/select.php">    <div class="font-icon-detail"><i class="pe-7s-note2"></i>
                                      <input type="text" value="INGREDIENTS">
                                    </div></a>
                                  </div>

                                    <div class="font-icon-list col-lg-2 col-md-3 col-sm-4 col-xs-6 col-xs-6">
                                <a href="../allergy_tbl/select.php">    <div class="font-icon-detail"><i class="pe-7s-settings"></i>
